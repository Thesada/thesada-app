...
var gatedRoutes = []struct {
	...
	{http.MethodGet, "/admin/devices/x/rules"},
	{http.MethodGet, "/admin/devices/x/rules/workspace"},
	{http.MethodPost, "/admin/devices/x/rules/workspace"},
	{http.MethodGet, "/admin/devices/x/secrets"},
	{http.MethodPost, "/admin/devices/x/secrets/set"},
	{http.MethodPost, "/admin/devices/x/secrets/clear"},
	{http.MethodPost, "/admin/devices/x/secrets/provision"},
	{http.MethodGet, "/admin/tenants/x/secrets"},
	{http.MethodPost, "/admin/tenants/x/secrets/set"},
	{http.MethodPost, "/admin/tenants/x/secrets/set-wifi"},
	{http.MethodPost, "/admin/tenants/x/secrets/clear"},
	{http.MethodPost, "/admin/tenants/x/secrets/provision"},
